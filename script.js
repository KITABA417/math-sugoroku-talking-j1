...
const DEFAULT_PROMPTS = [
    // 日常のこと
    { category: "日常のこと", text: "最近ちょっとうれしかったことは？" },
    { category: "日常のこと", text: "好きなおにぎりの具は？" },
    { category: "日常のこと", text: "朝ごはんはパン派？ごはん派？" },
    { category: "日常のこと", text: "休み時間にするとしたら何が好き？" },
    { category: "日常のこと", text: "最近笑ったことは？" },
    { category: "日常のこと", text: "今の気分を天気でたとえると？" },
    // 中1・中2のかんたんな復習
    { category: "中1・中2のかんたんな復習", text: "3x + 2x を簡単にすると？" },
    { category: "中1・中2のかんたんな復習", text: "正負の数で -3 + 5 は？" },
    { category: "中1・中2のかんたんな復習", text: "6a ÷ 2 は？" },
    { category: "中1・中2のかんたんな復習", text: "x=2 のとき 3x+1 の値は？" },
    { category: "中1・中2のかんたんな復習", text: "1次方程式 x + 4 = 9 を解くと？" },
    { category: "中1・中2のかんたんな復習", text: "y=2x に x=3 を代入すると y は？" },
    { category: "中1・中2のかんたんな復習", text: "三角形の内角の和は度？" },
    { category: "中1・中2のかんたんな復習", text: "平行四辺形の性質を1つ言おう" },
    { category: "中1・中2のかんたんな復習", text: "50% を小数で表すと？" },
    { category: "中1・中2のかんたんな復習", text: "2:3 と等しい比を1つ言おう" }
];
...
const CATEGORIES = ["日常のこと", "中1・中2のかんたんな復習", "カスタム"]; 
const CATEGORY_CLASSES = {
    "日常のこと": "cat-daily",
    "中1・中2のかんたんな復習": "cat-math",
    "カスタム": "cat-custom"
};
